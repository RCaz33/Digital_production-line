...
#   tech_id = int(tech.Technicien_id)
  ...
  new_batch = DB_Batch_XY(   # uses database
    ...
    Batch_XY_XX_batch = request.Batch_XY_XX_batch,
    Batch_XY_XX_masse = request.Batch_XY_XX_masse,
...
def update_batch_XY(db: Session, id: int, request: Batch_XY_Base):
  ...
  batch_XY.update({  # uses database
    ...
    DB_Batch_XY.Batch_XY_XX_batch : request.Batch_XY_XX_batch,
    DB_Batch_XY.Batch_XY_XX_masse : request.Batch_XY_XX_masse,
