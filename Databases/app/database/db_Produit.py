...
#   tech_id = int(tech.Technicien_id)
  ...
  new_batch = DB_Batch_Produit(   # uses database
    ...
    Batch_Produit_XY_batch = request.Batch_Produit_XY_batch,
    Batch_Produit_XY_Qte = request.Batch_Produit_XY_Qte,
...
def update_batch_Produit(db: Session, id: int, request: Batch_Produit_Base):
  ...
  batch_Produit.update({  # uses database
    ...
    DB_Batch_Produit.Batch_Produit_XY_batch : request.Batch_Produit_XY_batch,
    DB_Batch_Produit.Batch_Produit_XY_Qte : request.Batch_Produit_XY_Qte,
