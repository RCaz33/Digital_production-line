...
class Batch_KC8(Base):
    ...
    Batch_KC8_Technicien = Column(String(10), nullable=False)
    Batch_KC8_K_batch = Column(Integer, nullable=False)
    Batch_KC8_C_batch = Column(Integer, nullable=False)
...
class DB_Batch_OGD(Base):
    ...
    Batch_OGD_heure_fin = Column(DateTime, nullable=False)
