...
def clean_data(data):
    ...
    data.drop(index=['Batch_XY_name', 'Batch_XY_YY_batch', 'Batch_XY_Stock'],inplace=True)
    ...
    try:
        ...
        data.drop(index=['Batch_XY_XX_masse','Batch_XY_YY_Volume'],inplace=True)
