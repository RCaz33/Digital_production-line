...
class Form_Batch_KC8(FlaskForm):
    ...
    Batch_KC8_K_batch =  SelectField('Batch_K_name',choices=[])
    Batch_KC8_C_batch =  SelectField('Batch_C_name',choices=[])
...
class Form_Batch_OGD(FlaskForm):
    ...
    Batch_OGD_KC8_masse = FloatField('Masse KC8 utlilisé', default=0.6)
    Batch_OGD_THF_batch = SelectField('Batch_THF_name',choices=[])
    Batch_OGD_THF_Volume = IntegerField('Volume (L)',default=30)
